...
const LESSON_CONTENT = {
    ...
    '2-1': {
        ...
        resourceSummary: `
            <div class="resource-summary">
                ...
                <p>The Bitcoin whitepaper's impact extends far beyond the creation of a single cryptocurrency. It inspired an entire industry of blockchain technologies, cryptocurrencies, and decentralized applications. The concepts introduced, including decentralized consensus, cryptographic proof of work, and peer-to-peer networks, have been adapted and evolved in countless projects. As the foundation of the cryptocurrency and blockchain movement, understanding the Bitcoin whitepaper provides essential context for anyone seeking to understand the current state and future potential of decentralized technologies.</p>
            </div>
        `,
        resources: [
            {
    ...
    '4-1': {
        ...
        story: `
            <div class="story-paragraph">
                <p>Ethereum is a decentralized platform that enables smart contracts and decentralized applications (dApps) to be built and run without any downtime, fraud, control, or interference from a third party. It features its own cryptocurrency, Ether (ETH), which is used to power applications on the network. Ethereum introduced the concept of smart contracts, which are self-executing programs that automatically enforce agreements when predefined conditions are met. This programmability transforms blockchain from a simple ledger into a global, decentralized computer capable of running applications without downtime, censorship, or third-party interference, enabling new services like DeFi and NFTs.</p>
            </div>
        `,
        resourceSummary: `
            <div class="resource-summary">
